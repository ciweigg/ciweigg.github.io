    ...
    var createVideoIncon = function createVideoIncon() {
      ...
      for (var j = 0, len2 = res.list.length; j < len2; j++) {
        ...
        for (var i = 0, len = data.link.length; i < len; i++) {
          var minSrc = 'https://raw.githubusercontent.com/ciweigg/blog-back-up/master/shell/min_photos/' + data.link[i];
          var src = 'https://raw.githubusercontent.com/ciweigg/blog-back-up/master/shell/photos/' + data.link[i];
